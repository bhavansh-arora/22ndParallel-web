...
const fields_data = ['name','email','password','Delete Admin']
          ...
          <CCard>
            ...
            <CFormGroup row>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput type="password" id="email-input" name="email-input" placeholder="Enter Confirm Password" autoComplete="password" onChange={handleChangePassword}/>
