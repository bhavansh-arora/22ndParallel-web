...
const url = 'https://www.wissensquelle.com/testing/gvjygtyjftyftfuyfuuufufuy/22ndparallel/22ndParallel/public/api/get-users'
...
const fields_data = ['id','name','email','mobile','Change Password', 'Delete User']
...
axios.post("https://www.wissensquelle.com/testing/gvjygtyjftyftfuyfuuufufuy/22ndparallel/22ndParallel/public/api/create-user",formData, {
...
.catch(error => {
  setErrorMessage(error.message)
    ...
    function delete_user(e) {
      ...
      setSuccess(false)
      setError(false)
      axios.delete("https://www.wissensquelle.com/testing/gvjygtyjftyftfuyfuuufufuy/22ndparallel/22ndParallel/public/api/delete-user/"+e, {
...
.catch(error => {
  setErrorMessage(error.message)
    ...
    function change_user_password(e) {
      if(pass_modal.length<6){
        ...
        axios.put("https://www.wissensquelle.com/testing/gvjygtyjftyftfuyfuuufufuy/22ndparallel/22ndParallel/public/api/update-user-password/"+e,param ,{
  
  }).then(res => {
    if(res.data.status==1){
      setSuccessMessage("User's password has been successfully updated.")
        ...
        <>
          ...
          <CModal 
            ...
            >
              ...
              <CModalBody>
                Are you sure you want to remove the access of the user?
                The user will no longer be able to login and update data.
              </CModalBody>
              <CModalFooter>
                <CButton color="danger" onClick={() => delete_user(id)}>Remove Access</CButton>{' '}
              ...
              <CFormGroup row>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    ...
                    <CFormText className="help-block">Please enter user's password again</CFormText>
                  </CCol>
                </CFormGroup>
              </CModalBody>
              <CModalFooter>
                <CButton color="warning" onClick={() => change_user_password(id)}>Change Password</CButton>{' '}
            ...
            <CFormGroup row>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    ...
                    <CFormText className="help-block">Please enter user's mobile number</CFormText>
                  </CCol>
                </CFormGroup>
                <CFormGroup row>
                  <CCol md="3">
