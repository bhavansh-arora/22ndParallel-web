...
const ManageColors = React.lazy(() => import('./views/ManageColors/ManageColors'))
const ManageAdmins = React.lazy(() => import('./views/ManageAdmins/ManageAdmins'))
const Outlets = React.lazy(() => import('./views/Outlets/Outlets'))
...
const Users = React.lazy(() => import('./views/ManageAdmins/ManageAdmins'))


const routes = [
  { path: '/admins', name: 'Manage Admins', component: ManageAdmins},
  ...
  { path: '/products', name: 'Users', component: Products},
  { path: '/reports', name: 'Users', component: Reports},
  { path: '/manage_colors', name: 'Manage Colors', component: ManageColors},
  { path: '/paid_users', name: 'Paid Users', component: PaidUsers},
  { path: '/pending_users', name: 'Pending Users', component: PendingUsers},
  { path: '/registered_users', name: 'Registered Users', component: RegisteredUsers},
  { path: '/manage_users', name: 'Manage Users', component: ManageUsers},
